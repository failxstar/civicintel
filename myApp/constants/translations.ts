export type Language = 'english' | 'tamil' | 'hindi' | 'bengali';
...
export const translations = {
  english: {
    ...
    tryAnotherSearch: "Try another search or ward",
    briefSummary: "Brief Summary",
    describeInDetail: "Describe the problem in detail...",
    interactiveMap: "Interactive Map",
    mapOptimized: "Map interaction is optimized for Phone devices.",
    aiAnalysis: "AI Analysis",
    detected: "Detected:",
    riskFactors: "Risk Factors:",
    cityHealthIndicators: "City Health Indicators",
    ...
    logout: "Log Out",
    userName: "Demo User",
    siliguriMunicipalCorporation: "Smart City Administration",
    copyright: "© 2025 CivicIntel Intelligence"
  },
  ...
  hindi: {
    ...
    networkDiagnostics: "नेटवर्क डायग्नोस्टिक्स",
    issueDetails: "मुद्दे का विवरण",
    locationAccessNeeded: "स्थान पहुंच आवश्यक",
    tryAnotherSearch: "कोई अन्य खोज या वार्ड आज़माएं",
    briefSummary: "संक्षिप्त सारांश",
    describeInDetail: "समस्या का विस्तार से वर्णन करें...",
    interactiveMap: "इंटरैक्टिव मानचित्र",
    mapOptimized: "मानचित्र इंटरेक्शन फोन उपकरणों के लिए अनुकूलित है।",
    aiAnalysis: "एआई विश्लेषण",
    detected: "पता चला:",
    riskFactors: "जोखिम कारक:",
    cityHealthIndicators: "शहर स्वास्थ्य संकेतक",
    complianceRate: "अनुपालन दर",
    citizenResponse: "नागरिक प्रतिक्रिया",
    dept: "विभाग",
    ...
    logout: "लॉग आउट",
    userName: "डेमो यूजर",
    siliguriMunicipalCorporation: "स्मार्ट सिटी प्रशासन",
    copyright: "© 2025 सिविकइंटेल इंटेलिजेंस"
  },
  ...
  tamil: {
    ...
    noReportsFound: "புகார்கள் எதுவும் இல்லை",
    systemConfig: "கணினி அமைப்பு",
    networkDiagnostics: "பிணைய கண்டறிதல்",
    issueDetails: "பிரச்சினை விவரங்கள்",
    locationAccessNeeded: "இட அனுமதி தேவை",
    tryAnotherSearch: "வேறு தேடல் அல்லது வட்டத்தை முயற்சிக்கவும்",
    briefSummary: "சுருக்கமான தகவல்",
    describeInDetail: "பிரச்சினையை விரிவாக விளக்கவும்...",
    interactiveMap: "ஊடாடும் வரைபடம்",
    mapOptimized: "வரைபட செயல்பாடு தொலைபேசிகளுக்கு உகந்ததாக உள்ளது.",
    aiAnalysis: "AI பகுப்பாய்வு",
    detected: "கண்டறியப்பட்டது:",
    riskFactors: "ஆபத்து காரணிகள்:",
    cityHealthIndicators: "நகர சுகாதாரக் குறிகாட்டிகள்",
    complianceRate: "இணக்க விகிதம்",
    citizenResponse: "குடிமக்களின் பதில்",
    dept: "துறை",
    estResolution: "மதிப்பிடப்பட்ட தீர்வு",
    upvotes: "வாக்குகள்",
    points: "புள்ளிகள்",
    logout: "வெளியேறு",
    userName: "டெமோ பயனர்",
    siliguriMunicipalCorporation: "ஸ்மார்ட் சிட்டி நிர்வாகம்",
    copyright: "© 2025 CivicIntel நுண்ணறிவு"
  },
  ...
  bengali: {
    ...
    garbagePile: "আবর্জনা স্তূপ",
    drainageIssue: "নিকাশি সমস্যা",
    waterLogging: "জল জমে থাকা",
    brokenStreetlight: "ভাঙা স্ট্রিট লাইট",
    other: "অন্যান্য",
    notifications: "বিজ্ঞপ্তি",
    privacySecurity: "গোপনীয়তা এবং নিরাপত্তা",
    helpSupport: "সহায়তা এবং সমর্থন",
    noReportsFound: "কোনো রিপোর্ট পাওয়া যায়নি",
    systemConfig: "সিস্টেম কনফিগারেশন",
    networkDiagnostics: "নেটওয়ার্ক ডায়াগনস্টিকস",
    issueDetails: "সমস্যার বিবরণ",
    locationAccessNeeded: "অবস্থানের অনুমতি প্রয়োজন",
    tryAnotherSearch: "অন্য কোনো অনুসন্ধান বা ওয়ার্ড চেষ্টা করুন",
    briefSummary: "সংক্ষিপ্ত সারসংক্ষেপ",
    describeInDetail: "বিস্তারিতভাবে সমস্যার বর্ণনা দিন...",
    interactiveMap: "ইন্টারেক্টিவ் মানচিত্র",
    mapOptimized: "মানচিত্র ইন্টারঅ্যাকশন ফোনের জন্য অপ্টিমাইজ করা হয়েছে।",
    aiAnalysis: "এআই বিশ্লেষণ",
    detected: "শনাক্ত করা হয়েছে:",
    riskFactors: "ঝুঁকির কারণগুলি:",
    cityHealthIndicators: "শহরের স্বাস্থ্য সূচক",
    complianceRate: "পালনের হার",
    citizenResponse: "নাগরিক প্রতিক্রিয়া",
    dept: "বিভাগ",
    estResolution: "আনুমানিক সমাধানকাল",
    upvotes: "আপভোট",
    points: "পয়েন্ট",
    logout: "লগ আউট",
    userName: "ডেমো ইউজার",
    siliguriMunicipalCorporation: "স্মার্ট সিটি প্রশাসন",
    copyright: "© ২০২৫ সিভিকইন্টেল ইন্টেলিজেন্স"
  },
};
